    ...
    if (loginId && email && password && name && nickname) {
      ...
      try {
        ...
        if (verificationResponse.message) {
          ...
          setCodeSentMessage('인증 코드가 이메일로 발송되었습니다. 코드를 확인해주세요.'); // 인증 코드 발송 메시지 설정
      ...
      setLoginMessage('모든 필드를 채워주세요.'); //* 고난이도 주문ㅋㅋㅋㅋ
    }
  };
      ...
      <div className="card w-96 shadow-xl p-5">
        ...
        <div className="flex items-center mb-2 w-full">
          <div className="flex-grow mr-2">
            ...
            <Button onClick={handleCheckLoginId} className="btn btn-secondary flex-shrink-0">
              중복확인
            </Button>
          </div>
          {loginMessage && (
        ...
        <div className="relative w-full mt-2 mb-2">
          ...
          />
          <div className="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" onClick={onToggleHide}>
